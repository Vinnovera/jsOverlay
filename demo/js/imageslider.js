(function(){
	...
	function onOpenBtnClick(e){
		...
		// Create html based on image data and template
		...
		imageslider_holder.innerHTML = template;
		...
		document.getElementById('imageslider').style.width = (items.length*100)+'%';
		var listelems = document.getElementById('imageslider').getElementsByTagName('li');
		for(var i=0;i<listelems.length;i++){
			listelems[i].style.width = (100/items.length) + '%';
		}
